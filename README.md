...
- **Firewall**: Configured firewall to restrict access to MongoDB to trusted IPs.
- **Authentication**: Basic IP-based authentication for the database.
...
1. **Repository Structure**:
   - Code organized into `/terraform`, `/backend`, and `/frontend` directories.
   - Ensure each component is modular and well-documented.
   
2. **Commits**:
   - Commit frequently with meaningful messages.
   - Always squash commits when merging to the main branch.
   - Avoid force pushing.

3. **Delivery**:
   - Push your code to a **public GitHub repository**.
   - Submit the GitHub link via email.
